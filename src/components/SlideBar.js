    ...
    render() {
        return (
            <div className="sidebar">
                <Link to='/'>
                <img width="80" alt='' className="rounded-circle" height="80" src="https://image.roku.com/developer_channels/prod/7c7677568f4a87f91abfa1b8a9cc94e952b44406574ac0db7bf08b3bc76c62a4.png"/>
                </Link>
